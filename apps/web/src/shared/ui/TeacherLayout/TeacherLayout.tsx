      ...
      <div className="teacher-layout">
        ...
        <aside className="teacher-sidebar">
          <div className="teacher-sidebar__header">
            <Link to="/dashboard" className="teacher-logo">
              <svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" className="teacher-logo__icon">
              ...
              <span className="teacher-logo__text">ViaQuiz</span>
            </Link>
          </div>
          ...
          <nav className="teacher-sidebar__nav">
            <Link
              to="/classes"
              className={`teacher-nav-item ${location.pathname.startsWith('/classes') ? 'is-active' : ''}`}
            >
              <svg className="teacher-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <Link
              to="/library"
              className={`teacher-nav-item ${location.pathname.startsWith('/library') ? 'is-active' : ''}`}
            >
              <svg className="teacher-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <Link
              to="/reports"
              className={`teacher-nav-item ${location.pathname.startsWith('/reports') ? 'is-active' : ''}`}
            >
              <svg className="teacher-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="teacher-sidebar__footer">
            <p className="teacher-sidebar__copyright">
        ...
        <div className="teacher-main-wrapper">
          ...
          <header className="teacher-topbar">
            <div className="teacher-topbar__left">
              {isProfile ? (
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="teacher-topbar__title">Профіль</span>
                </button>
              ) : isQuizDetails ? (
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="teacher-topbar__title">Вікторина</span>
                </button>
              ) : (
                <h1 className="teacher-topbar__title">Головна</h1>
              )}
            </div>
          ...
          <div className="teacher-topbar__actions">
            ...
            <Link to="/#enter-code" className="btn-teacher-code">
              Введіть код
            </Link>

            <Link to="/profile" className="teacher-user-profile-link" title="Перейти до профілю">

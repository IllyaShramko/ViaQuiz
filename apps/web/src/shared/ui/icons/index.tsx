...
/** ViaQuiz brand logo icon */
export const LogoIcon: React.FC<IconProps> = ({ size = 24, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 20 20"
...
export const TimerIcon: React.FC<IconProps> = ({ size = 18, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 29 30"
  ...
  >
    <path
      d="M5.45629 8.95833C4.29958 10.6864 3.625 12.7645 3.625 15C3.625 21.0061 8.49391 25.875 14.5 25.875C20.5061 25.875 25.375 21.0061 25.375 15C25.375 8.99391 20.5061 4.125 14.5 4.125V7.75M14.5 15L9.66667 10.1667"
      stroke="currentColor"
      strokeWidth="2.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
/** Heart / like icon */
export const HeartIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
...
/** Users / group / participants icon */
export const UsersIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
...
/** Single user / participant / avatar icon */
export const UserIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
...
/** Star / rating / points icon */
export const StarIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
...
/** Clock icon */
export const ClockIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
...
export const ArrowRightIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
...
/** Arrow pointing left <- */
export const ArrowLeftIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
...
export const NextIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 12 7"
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M11.2142 4.10693L7.10879 6.84645C6.52558 7.22183 6.00197 6.86494 6.00197 6.24019V4.49808L2.13225 6.84645C1.54996 7.22183 0.5 6.86494 0.5 6.24019V0.759861C0.5 0.135107 1.54996 -0.221763 2.13225 0.15274L6.00197 2.50218V0.759861C6.00197 0.135107 6.52558 -0.221763 7.10879 0.15274L11.0601 2.89333C11.5315 3.19696 11.6855 3.8033 11.2142 4.10693Z"
    />
  </svg>
);

/** Warning triangle icon */
export const WarningIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
...
/** Mail / envelope icon */
export const MailIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
...
/** Lock / padlock icon */
export const LockIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
...
/** Calendar icon */
export const CalendarIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
...
/** Clipboard icon */
export const ClipboardIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
...
/** Hourglass icon */
export const HourglassIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
...
/** Keyboard icon */
export const KeyboardIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
  ...
  >
    <rect x="2" y="4" width="20" height="16" rx="2" />
    <path d="M6 8h.001M10 8h.001M14 8h.001M18 8h.001M6 12h.001M10 12h.001M14 12h.001M18 12h.001M8 16h8" strokeWidth="2.5" />
  </svg>
);

/** Eye off / hide answer icon */
export const ViewEyeOffIcon: React.FC<IconProps> = ({ size = 20, width, height, ...props }) => (
  <svg
    width={width ?? size}
    height={height ?? size}
    viewBox="0 0 24 24"
